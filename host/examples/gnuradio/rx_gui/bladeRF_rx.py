...
class bladeRF_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, buflen=4096, dc_offset_i=0, dc_offset_q=0, instance=0, num_buffers=16, num_xfers=8, rx_bandwidth=1.5e6, rx_frequency=915e6, rx_lna_gain=6, rx_sample_rate=3e6, rx_vga_gain=20, serial="", verbosity="info"):
        ...
        self._gui_dc_offset_q_win = RangeWidget(self._gui_dc_offset_q_range, self.set_gui_dc_offset_q, "Q DC Offset", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._gui_dc_offset_i_win = RangeWidget(self._gui_dc_offset_i_range, self.set_gui_dc_offset_i, "I DC Offset", "counter_slider", float, QtCore.Qt.Horizontal)
...
def argument_parser():
    ...
    parser.add_argument(
        "-f", "--rx-frequency", dest="rx_frequency", type=eng_float, default=eng_notation.num_to_str(float(915e6)),
        help="Set Frequency [default=%(default)r]")
    parser.add_argument(
        "-l", "--rx-lna-gain", dest="rx_lna_gain", type=intx, default=6,
        help="Set RX LNA Gain [default=%(default)r]")
    parser.add_argument(
        "-s", "--rx-sample-rate", dest="rx_sample_rate", type=eng_float, default=eng_notation.num_to_str(float(3e6)),
        help="Set Sample Rate [default=%(default)r]")
    parser.add_argument(
        "-g", "--rx-vga-gain", dest="rx_vga_gain", type=intx, default=20,
